...
mai_alias = on_command("舞萌", priority=5)
...
mai_bind_alias = on_command("bd", priority=5)

@mai_bind_cmd.handle()
@mai_bind_alias.handle()
...
mai_bind_df_alias = on_command("bdsy", priority=5)

@mai_bind_df_cmd.handle()
@mai_bind_df_alias.handle()
...
mai_unbind_alias = on_command("jb", priority=5)

@mai_unbind_cmd.handle()
@mai_unbind_alias.handle()
...
mai_plate_alias = on_command("pz", priority=5)

@mai_plate_cmd.handle()
@mai_plate_alias.handle()
